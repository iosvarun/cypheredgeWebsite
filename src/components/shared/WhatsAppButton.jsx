...
import { SITE_CONFIG, getWhatsAppUrl } from '../../data/siteConfig.js';
...
export default function WhatsAppButton() {
  ...
  const handleWhatsAppClick = () => {
    ...
    const url = getWhatsAppUrl ? getWhatsAppUrl() : `https://wa.me/919999598474`;
    window.open(url, '_blank', 'noopener,noreferrer');
  };

  const handleCallClick = () => {
    trackCTA('phone_call_click');
    window.location.href = 'tel:+919999598474';
  };
  ...
  return (
    <div className={`floating-actions-container ${isVisible ? 'visible' : ''}`}>
      ...
      <a
        href="tel:+919999598474"
        className="floating-btn call-btn"
        onClick={handleCallClick}
        aria-label="Call +919999598474"
        title="Call +91 9999598474"
      >
        <Phone size={22} />
      </a>
      ...
      {SITE_CONFIG?.whatsappNumber && (
        <button
          ...
          title="Message on WhatsApp (+91 9999598474)"
        >
          <svg
